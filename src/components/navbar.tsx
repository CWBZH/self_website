...
export default async function Navbar() {
  ...
  const socialItems = [
    settings.githubUrl ? { label: "GitHub", href: settings.githubUrl, icon: Icons.github } : null,
    settings.email ? { label: "Email", href: `mailto:${settings.email}`, icon: Icons.email } : null,
          ...
          return (
            <Tooltip key={item.href}>
              <TooltipTrigger asChild>
                <LanguageAwareAnchor href={item.href}>
