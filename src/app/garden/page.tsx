  ...
  return (
    <main className="mx-auto w-full max-w-6xl py-14 sm:py-20 md:py-24">
      <header className="mb-9 border-b border-border pb-8 sm:mb-14 sm:pb-10">
        ...
        <h1 className="mt-4 max-w-4xl text-balance text-4xl font-medium leading-[1.02] tracking-tight sm:text-5xl md:text-7xl">{settings.gardenTitle}</h1>
        <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground sm:mt-5 sm:text-lg sm:leading-8">{settings.gardenDescription}</p>
      </header>
